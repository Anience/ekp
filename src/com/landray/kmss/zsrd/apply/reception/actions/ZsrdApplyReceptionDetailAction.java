...
public class ZsrdApplyReceptionDetailAction extends DataAction {
	...
	public ActionForward data(ActionMapping mapping, ActionForm form,
		...
		IZsrdApplyReceptionService zsrdApplyReceptionService = (IZsrdApplyReceptionService) getServiceImp(request);
		...
		try {
			...
			if(adminman.equals("1183b0b84ee4f581bba001c47a78b2d9".toString()))
			{
				stringBuffer.append("SELECT\n" + "	r.fd_id,\n"
						+ "	r.fd_foreign_depart_name ,\n" + "	r.fd_reception_type,\n"
						+ "	r.fd_reception_time,\n" 
						+ "	p.fd_name creatorName\n" + " FROM\n"
						+ " zsrd_apply_reception r, \n"
						+ " sys_org_element p \n" + " Where \n"
						+ " r.doc_creator_id = p.fd_id");
			}
				...
				stringBuffer.append("SELECT\n" + "	r.fd_id,\n"
						...
						+ " and r.fd_id = w.fd_process_id   \n"
						+ " and r.doc_creator_id = p.fd_id");
			...
			Page page1 = zsrdApplyReceptionService.listch(hqlInfo);
