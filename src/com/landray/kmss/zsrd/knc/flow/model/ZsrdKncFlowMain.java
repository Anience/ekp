 ...
 */
public class ZsrdKncFlowMain  extends BaseModel  implements IAttachment,ISysWfMainModel{
	...
	private ZsrdKncFlowCategory docCategory;
	
	
	
	public ZsrdKncFlowCategory getDocCategory() {
		return docCategory;
	}

	public void setDocCategory(ZsrdKncFlowCategory docCategory) {
	...
	public Class<ZsrdKncFlowMainForm> getFormClass() {
		return ZsrdKncFlowMainForm.class;
	}
