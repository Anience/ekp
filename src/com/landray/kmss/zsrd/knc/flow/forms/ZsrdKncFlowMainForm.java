 ...
 */
public class ZsrdKncFlowMainForm extends ExtendForm implements IAttachmentForm,ISysWfMainForm  {
    ...
    public Class<ZsrdKncFlowMain> getModelClass() {
        return ZsrdKncFlowMain.class;
    }
        ...
        if (toModelPropertyMap == null) {
            ...
            toModelPropertyMap.put("docCreatorId",
                    new FormConvertor_IDToModel("docCreator",
                            SysOrgElement.class));
            toModelPropertyMap.put("docCategoryId", new FormConvertor_IDToModel("docCategory", ZsrdKncFlowCategory.class));
        }
