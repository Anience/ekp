package com.landray.kmss.zsrd.knc.stdquery.webservice.model;
...
public class StdQuery {
		...
		//程序名称
		public String progNmae;
		//程序编码
		public String progCode;
		
		public String getProgNmae() {
			return progNmae;
		}
		public void setProgNmae(String progNmae) {
			this.progNmae = progNmae;
		}
