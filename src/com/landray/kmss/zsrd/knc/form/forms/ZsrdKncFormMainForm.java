 ...
 */
public class ZsrdKncFormMainForm extends ExtendForm implements IAttachmentForm,ISysWfMainForm {
    ...
    public Class<ZsrdKncFormMain> getModelClass() {
        return ZsrdKncFormMain.class;
    }
        ...
        if (toModelPropertyMap == null) {
            ...
            toModelPropertyMap.put("docCreatorId",
                    new FormConvertor_IDToModel("docCreator",
                            SysOrgElement.class));
            toModelPropertyMap.put("docCategoryId", new FormConvertor_IDToModel("docCategory", ZsrdKncFormCategory.class));
        }
