 ...
 */
public class ZsrdKncFlowAction extends ExtendAction {
	protected IZsrdKncFlowService zsrdKncFlowService;

	protected IBaseService getServiceImp(HttpServletRequest request) {
		if(zsrdKncFlowService == null){
			zsrdKncFlowService = (IZsrdKncFlowService)getBean("zsrdKncFlowService");
		}
		return zsrdKncFlowService;
	}
