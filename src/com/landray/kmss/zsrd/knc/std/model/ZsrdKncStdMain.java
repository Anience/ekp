 ...
 */
public class ZsrdKncStdMain  extends BaseModel  implements IAttachment,ISysWfMainModel{
	...
	private ZsrdKncStdCategory docCategory;
	
	
	
	public ZsrdKncStdCategory getDocCategory() {
		return docCategory;
	}

	public void setDocCategory(ZsrdKncStdCategory docCategory) {
	 ...
	 * 接口管理部门
	 */
	private SysOrgElement fdDepartManage;
	
	public SysOrgElement getFdDepartManage() {
		return fdDepartManage;
	}

	public void setFdDepartManage(SysOrgElement fdDepartManage) {
		this.fdDepartManage = fdDepartManage;
	}
	...
	public Class<ZsrdKncStdMainForm> getFormClass() {
		return ZsrdKncStdMainForm.class;
	}
	...
	public ModelToFormPropertyMap getToFormPropertyMap() {
		if (toFormPropertyMap == null) {
			...
			toFormPropertyMap.put("fdDepartManage.fdId", "fdDepartId");
			toFormPropertyMap.put("fdDepartManage.fdName", "fdDepartName");
