	...
	<template:replace name="content">
		<c:choose>
			<c:when test="${param.filter == '1' }">
				<c:import url="/zsrd/knc/stdquery/zsrd_knc_std_query_detail/mobile/filter.jsp" charEncoding="UTF-8">
				</c:import>
			</c:when>
			<c:otherwise>
				<c:import url="/zsrd/knc/stdquery/zsrd_knc_std_query_detail/mobile/listview.jsp" charEncoding="UTF-8">
				</c:import>
			</c:otherwise>
		</c:choose>
