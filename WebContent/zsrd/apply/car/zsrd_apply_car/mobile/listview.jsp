...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
	<div
		...
		data-dojo-props="defaultUrl:'/zsrd/apply/car/zsrd_apply_car/mobile/nav.jsp', modelName:'com.landray.kmss.zsrd.apply.car.model.ZsrdApplyCar'">
	</div>
	<div
		data-dojo-type="mui/search/SearchButtonBar" 
		data-dojo-props="modelName:'com.landray.kmss.zsrd.apply.car.model.ZsrdApplyCar'">
	</div>
</div>
