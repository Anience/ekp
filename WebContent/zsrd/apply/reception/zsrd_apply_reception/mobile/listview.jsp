...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
	<div
		...
		data-dojo-props="defaultUrl:'/zsrd/apply/reception/zsrd_apply_reception/mobile/nav.jsp', modelName:'com.landray.kmss.zsrd.apply.reception.model.ZsrdApplyReception'">
	</div>
	<div
		data-dojo-type="mui/search/SearchButtonBar" 
		data-dojo-props="modelName:'com.landray.kmss.zsrd.apply.reception.model.ZsrdApplyReception'">
	</div>
</div>
