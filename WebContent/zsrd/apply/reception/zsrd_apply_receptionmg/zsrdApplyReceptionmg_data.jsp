...
<list:data>
	<list:data-columns var="zsrdApplyReceptionmg" list="${queryPage.list}" varIndex="status">
		...
		<list:data-column property="fdTypename" title="${ lfn:message('zsrd-apply-reception:zsrdApplyReceptionmg.fdTypename') }">
		</list:data-column>
		<list:data-column property="fdPrice" title="${ lfn:message('zsrd-apply-reception:zsrdApplyReceptionmg.fdPrice') }">
		</list:data-column>
		<list:data-column property="fdPer" title="${ lfn:message('zsrd-apply-reception:zsrdApplyReceptionmg.fdPer') }">
		</list:data-column>
		<list:data-column property="fdNum" title="${ lfn:message('zsrd-apply-reception:zsrdApplyReceptionmg.fdNum') }">
		</list:data-column>
