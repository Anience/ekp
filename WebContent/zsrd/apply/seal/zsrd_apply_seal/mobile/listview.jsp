...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
	<div
		...
		data-dojo-props="defaultUrl:'/zsrd/apply/seal/zsrd_apply_seal/mobile/nav.jsp', modelName:'com.landray.kmss.zsrd.apply.seal.model.ZsrdApplySeal'">
	</div>
	<div
		data-dojo-type="mui/search/SearchButtonBar" 
		data-dojo-props="modelName:'com.landray.kmss.zsrd.apply.seal.model.ZsrdApplySeal'">
	</div>
</div>
