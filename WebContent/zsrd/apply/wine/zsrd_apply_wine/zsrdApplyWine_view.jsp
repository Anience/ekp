...
<template:include ref="config.view">
    ...
    <template:replace name="toolbar">
        ...
        <ui:toolbar id="toolbar" layout="sys.ui.toolbar.float" count="3">
            <kmss:auth requestURL="/zsrd/apply/wine/zsrd_apply_wine/zsrdApplyWine.do?method=edit&fdId=${param.fdId}"
                       requestMethod="GET">
                <ui:button text="${lfn:message('button.edit')}"
                           onclick="Com_OpenWindow('zsrdApplyWine.do?method=edit&fdId=${param.fdId}','_self');"
                           order="2">
                </ui:button>
            </kmss:auth>
            <kmss:auth requestURL="/zsrd/apply/wine/zsrd_apply_wine/zsrdApplyWine.do?method=delete&fdId=${param.fdId}"
                       requestMethod="GET">
                <ui:button text="${lfn:message('button.delete')}" order="4"
                           onclick="deleteDoc('zsrdApplyWine.do?method=delete&fdId=${param.fdId}');">
                </ui:button>
            </kmss:auth>
    ...
    <template:replace name="content">
        ...
        <p class="txttitle"><bean:message bundle="zsrd-apply-wine" key="table.zsrdApplyWine"/></p>
                ...
                <tr LKS_LabelName='${ lfn:message('config.baseinfo') }'>
                    ...
                    <table class="tb_normal" width=100%>
                        <tr>
                            ...
                            <td width="35%">
                                <c:out value="${zsrdApplyWineForm.docCreatorName}"/>
                            </td>
                            <td class="td_normal_title" width=15%>
