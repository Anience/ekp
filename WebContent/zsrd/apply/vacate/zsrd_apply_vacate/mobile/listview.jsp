...
<div data-dojo-type="mui/header/Header" data-dojo-props="height:'3.8rem'">
	<div
		...
		data-dojo-props="defaultUrl:'/zsrd/apply/vacate/zsrd_apply_vacate/mobile/nav.jsp', modelName:'com.landray.kmss.zsrd.apply.vacate.model.ZsrdApplyVacate'">
	</div>
	<div
		data-dojo-type="mui/search/SearchButtonBar" 
		data-dojo-props="modelName:'com.landray.kmss.zsrd.apply.vacate.model.ZsrdApplyVacate'">
	</div>
</div>
