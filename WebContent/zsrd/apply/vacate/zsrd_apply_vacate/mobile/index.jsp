	...
	<template:replace name="content">
		<c:choose>
			<c:when test="${param.filter == '1' }">
				<c:import url="/zsrd/apply/vacate/zsrd_apply_vacate/mobile/filter.jsp" charEncoding="UTF-8">
				</c:import>
			</c:when>
			<c:otherwise>
				<c:import url="/zsrd/apply/vacate/zsrd_apply_vacate/mobile/listview.jsp" charEncoding="UTF-8">
				</c:import>
			</c:otherwise>
		</c:choose>
