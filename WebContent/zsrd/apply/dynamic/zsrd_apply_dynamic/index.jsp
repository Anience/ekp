...
<template:include ref="default.list">
	...
	<template:replace name="nav">
		<script>
            function addDoc(){
                Com_OpenWindow("${LUI_ContextPath}/zsrd/apply/dynamic/zsrd_apply_dynamic/zsrdApplyDynamic.do?method=add&docCategoryId=${JsParam.categoryId}");
            }
            function delDoc(){
                var values = [];
                ...
                seajs.use(['lui/jquery','lui/dialog','lui/topic'], function($, dialog , topic){
                    dialog.confirm('<bean:message key="page.comfirmDelete"/>',function(value){
                        if(value==true){
                            ...
                            $.post('${LUI_ContextPath}/zsrd/apply/dynamic/zsrd_apply_dynamic/zsrdApplyDynamic.do?method=deleteall&categoryId=${param.categoryId}',$.param({"List_Selected":values},true),function(data){
                                if(del_load!=null){
                                    del_load.hide();
		...
		<ui:combin ref="menu.nav.create">
			<ui:varParam name="title" value="${ lfn:message('zsrd-apply-dynamic:module.zsrd.apply.dynamic') }" />
			<ui:varParam name="button">
				[
				<kmss:auth requestURL="/zsrd/apply/dynamic/zsrd_apply_dynamic/zsrdApplyDynamic.do?method=add">
					{
					"text": "${ lfn:message('zsrd-apply-dynamic:module.zsrd.apply.dynamic') }",
		...
		<div class="lui_list_nav_frame">
			<ui:accordionpanel>
				...
				<%--<ui:content title="${ lfn:message('list.otherOpt') }">
					<ul class='lui_list_nav_list'>
						<li><a href="${LUI_ContextPath }/sys/?module=zsrd/apply/dynamic" target="_blank">${ lfn:message('list.manager') }</a></li>
					</ul>
				</ui:content>--%>
			</ui:accordionpanel>
		</div>
	...
	<template:replace name="content">
		...
		<list:criteria id="criteria1">
			...
			<list:cri-auto modelName="com.landray.kmss.zsrd.apply.dynamic.model.ZsrdApplyDynamic"
						   property="docSubject;docCreateTime" />
		</list:criteria>
				...
				<tr>
					...
					<td align="right">
						<ui:toolbar count="3">
							...
							<kmss:auth requestURL="/zsrd/apply/dynamic/zsrd_apply_dynamic/zsrdApplyDynamic.do?method=deleteall">
							...
							<c:import url="/sys/introduce/import/sysIntroduceMain_cancelbtn.jsp" charEncoding="UTF-8">
								<c:param name="fdModelName" value="com.landray.kmss.zsrd.apply.dynamic.model.ZsrdApplyDynamic" />
							</c:import>
							--%>
							<%-- 修改权限
							<c:import url="/sys/right/import/doc_right_change_button.jsp" charEncoding="UTF-8">
								<c:param name="modelName" value="com.landray.kmss.zsrd.apply.dynamic.model.ZsrdApplyDynamic" />
							</c:import>
							--%>
						</ui:toolbar>
					</td>
		...
		<list:listview id="listview">
			<ui:source type="AjaxJson">
				{url:'/zsrd/apply/dynamic/zsrd_apply_dynamic/zsrdApplyDynamicIndex.do?method=listChildren&fdCategoryId=${JsParam.fdCategoryId}&docCategoryId=${JsParam.docCategoryId}'}
			</ui:source>
			<!-- 列表视图 -->
			<list:colTable isDefault="false"
						   rowHref="/zsrd/apply/dynamic/zsrd_apply_dynamic/zsrdApplyDynamic.do?method=view&fdId=!{fdId}"  name="columntable">
				...
				<list:col-auto props="docSubject;fdDescription;docStatus;docAlterTime;fdLastModifiedTime;fdCategory;fdUrl;docCreator.fdName;fdDepart.fdName;docCategory.fdName;docCreateTime"></list:col-auto>
			</list:colTable>
		</list:listview>
		...
		<%--<list:listview id="listview">
			<ui:source type="AjaxJson">
				{url:'/zsrd/apply/dynamic/zsrd_apply_dynamic/zsrdApplyDynamic.do?method=data&categoryId=${param.categoryId}'}
			</ui:source>
			<!-- 列表视图 -->
			<list:colTable isDefault="false"
						   rowHref="/zsrd/apply/dynamic/zsrd_apply_dynamic/zsrdApplyDynamic.do?method=view&fdId=!{fdId}"  name="columntable">
				...
				<list:col-auto props="docSubject;fdDescription;docStatus;docCreateTime;docAlterTime;fdLastModifiedTime;fdCategory;fdUrl;docCreator.fdName;fdDepart.fdName;docCategory.fdName"></list:col-auto>
			</list:colTable>
			<!-- 摘要视图 -->
			&lt;%&ndash;<list:rowTable isDefault="ture"
						   rowHref="/zsrd/apply/dynamic/zsrd_apply_dynamic/zsrdApplyDynamic.do?method=view&fdId=!{fdId}" name="rowtable" >
				<list:row-template ref="sys.ui.listview.rowtable">
                    ...
                    docSubject;icon;fdDescription;docCategory.fdName;docAuthor.fdName;docDept.fdName;docPublishTime;tag
                     &ndash;%&gt;
					{"showOtherProps":"docStatus;docCreateTime;docAlterTime;fdLastModifiedTime;fdCategory;fdUrl;docCreator.fdName;fdDepart.fdName"}
				</list:row-template>
			</list:rowTable>&ndash;%&gt;
		</list:listview>--%>
