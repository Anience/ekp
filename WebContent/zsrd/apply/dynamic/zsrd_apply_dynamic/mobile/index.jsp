	...
	<template:replace name="content">
		<c:choose>
			<c:when test="${param.filter == '1' }">
				<c:import url="/zsrd/apply/dynamic/zsrd_apply_dynamic/mobile/filter.jsp" charEncoding="UTF-8">
				</c:import>
			</c:when>
			<c:otherwise>
				<c:import url="/zsrd/apply/dynamic/zsrd_apply_dynamic/mobile/listview.jsp" charEncoding="UTF-8">
				</c:import>
			</c:otherwise>
		</c:choose>
